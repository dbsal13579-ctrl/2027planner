        ...
        <div class="card day-task-card">
            <div class="flex gap-3 mb-4">
                <button onclick="toggleDayTasksCollapse()" title="${dayTasksCollapsed?'항목 펼치기':'항목 접기'}"
                    class="shrink-0 w-11 flex items-center justify-center text-slate-400 hover:text-pc transition-colors"
                    style="background:transparent;border:none;font-size:11px;transform:rotate(${dayTasksCollapsed?'-90deg':'0deg'});transition:transform .2s">▽</button>
