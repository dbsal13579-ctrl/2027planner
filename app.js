...
function renderTimeline(){
    ...
    for(let h=minHour;h<maxHour;h++){
        ...
        rows.push(`<div style="display:flex;align-items:center;">
            <div style="width:${hourLabelW}px;text-align:right;padding-right:${isDayTimeline?5:4}px;font-size:${hourLabelFont}px;font-weight:800;color:#94a3b8;flex-shrink:0;">${hourLabel}</div>
